...
const char * const BITCOIN_CONF_FILENAME = "opayk.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "OpayK";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/OpayK";
#else
    // Unix-like
    return pathRet / ".opayk";
#endif
#endif
}
