...
{
    const char* pszTimestamp = "Genesis testnet1";
    const CScript genesisOutputScript = CScript() << ParseHex("04aeece0856af37123302f0cbfe515117a0a5d1afe5ad5445872afa808f1ad1bf160a753a40b70080fc568e397a18d142261251da208734f227560d3cc54ff71e8") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x24a1e7974dc9c260e51763c391ef4207518247efd9edb6b4cee4f4fcd39e4a99"); 
        ...
        genesis = CreateGenesisBlock(1701315386, 2329514072, 0x2000ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6962c5063c7eefcb5c6c08f64583b47c6b81846b4345e3b4856436327093a003"));
        ...
        vSeeds.emplace_back("node1.OpayK.io");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x24a1e7974dc9c260e51763c391ef4207518247efd9edb6b4cee4f4fcd39e4a99")},
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 24a1e7974dc9c260e51763c391ef4207518247efd9edb6b4cee4f4fcd39e4a99
            /* nTime    */ 1701315386,
            /* nTxCount */ 0,
            /* dTxRate  */ 0
        };
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x7b3cc00120db6316db1a1ed57f321317d13e12ff1513f9df7f30210f57655174"); 
        ...
        genesis = CreateGenesisBlock(1701315416, 974869, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7b3cc00120db6316db1a1ed57f321317d13e12ff1513f9df7f30210f57655174"));
        assert(genesis.hashMerkleRoot == uint256S("0xed2d6e3aa53bfb2a887c1417531f199b0c6a1521f28b539dc648931ef556b768"));
        ...
        checkpointData = {
            {
                {0, uint256S("7b3cc00120db6316db1a1ed57f321317d13e12ff1513f9df7f30210f57655174")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 7b3cc00120db6316db1a1ed57f321317d13e12ff1513f9df7f30210f57655174
            /* nTime    */ 1701315416,
            /* nTxCount */ 0,
            /* dTxRate  */ 0,
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1701315635, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x866e48efeb1ba25f1aa9c55fada6082f1d7b9431ccb12038da017f141811c642"));
        assert(genesis.hashMerkleRoot == uint256S("0xed2d6e3aa53bfb2a887c1417531f199b0c6a1521f28b539dc648931ef556b768"));
        ...
        checkpointData = {
            {
                {0, uint256S("866e48efeb1ba25f1aa9c55fada6082f1d7b9431ccb12038da017f141811c642")},
            }
        };
