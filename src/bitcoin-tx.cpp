...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " opayk-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  opayk-tx [options] <hex-tx> [commands]  Update hex-encoded opayk transaction\n" +
            "or:     opayk-tx [options] -create [commands]   Create hex-encoded opayk transaction\n" +
            "\n";
