...
bech32_templates = [
  ...
  ('opayk',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('opayk',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('opayk',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('opayk',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('topayk',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('topayk',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('topayk',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('topayk',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('topayk',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('topayk',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('topayk',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('topayk',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('ropayk',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ropayk',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ropayk',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('ropayk', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('topayk',   17, 32, Encoding.BECH32M, False, False, False),
  ('ropayk',  3,  1, Encoding.BECH32M, False, False, False),
  ('opayk',   15, 41, Encoding.BECH32M, False, False, False),
  ('topayk',    0, 16, Encoding.BECH32,  False, False, False),
  ('ropayk',  0, 32, Encoding.BECH32,  True,  False, False),
  ('opayk',    0, 16, Encoding.BECH32,  True,  False, False),
  ('topayk',    0, 32, Encoding.BECH32,  False, True,  False),
  ('ropayk',  0, 20, Encoding.BECH32,  False, False, True),
  ('opayk',    0, 20, Encoding.BECH32M, False, False, False),
  ('topayk',    0, 32, Encoding.BECH32M, False, False, False),
  ('ropayk',  0, 20, Encoding.BECH32M, False, False, False),
  ('opayk',    1, 32, Encoding.BECH32,  False, False, False),
  ('topayk',    2, 16, Encoding.BECH32,  False, False, False),
  ('ropayk', 16, 20, Encoding.BECH32,  False, False, False),
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['opayk', 'topayk', 'ropayk']:
