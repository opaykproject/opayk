...
"""Verify that starting opayk with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start opayk with -h for help text")
        ...
        self.log.info("Start opayk with -version for version information")
        ...
        self.log.info("Start opaykd with -fakearg to make sure it does not start")
