Contributing to OpayK Core
============================

The OpayK Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the OpayK Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/opayk-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to opayk-qt
...
The following applies to code changes to the OpayK Core project (and related
projects such as libsecp256k1), and is not to be confused with overall OpayK
Network Protocol consensus changes.

Whether a pull request is merged into OpayK Core rests with the project merge
...
Patches that change OpayK consensus rules are considerably more involved than
...
Where a patch set proposes to change the OpayK consensus, it must have been
...
The project leader is the release manager for each OpayK Core release.
