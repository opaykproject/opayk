# Fuzzing OpayK Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing OpayK Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone Https://github.com/opaykchain
$ cd opayk/
$ ./autogen.sh
...
[`process_message`](Https://github.com/opaykchain/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](Https://github.com/opaykchain/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](Https://github.com/opaykchain/tree/master/src/test/fuzz).
...
Every single pull request submitted against the OpayK Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make OpayK Core more robust.
...
with certain assembly code from OpayK Core's code. See [developer notes on sanitizers](Https://github.com/opaykchain/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing OpayK Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing OpayK Core using [`afl-fuzz`](https://github.com/google/afl):
