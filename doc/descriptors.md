# Support for Output Descriptors in OpayK Core

Since OpayK Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `opayk1...` for mainnet or `topayk1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing OpayK Core wallets, a convenience function `combo` is
